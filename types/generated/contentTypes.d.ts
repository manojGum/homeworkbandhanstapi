...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    article_images: Attribute.Media & Attribute.Required;
    artical_title: Attribute.String;
    public_date: Attribute.Date & Attribute.Required;
...
export interface ApiBrandsPartnerBrandsPartner extends Schema.CollectionType {
  ...
  attributes: {
    ...
    brand_message: Attribute.Text & Attribute.Required;
...
export interface ApiCardBannerCardBanner extends Schema.CollectionType {
  ...
  attributes: {
    sm_title: Attribute.String & Attribute.Required;
    bg_title: Attribute.String & Attribute.Required;
    bannerDetails: Attribute.Component<'card-banner.card-banner', true> &
      Attribute.Required;
    card_category: Attribute.Relation<
...
export interface ApiCardCategoryCardCategory extends Schema.CollectionType {
  ...
  attributes: {
    card: Attribute.String & Attribute.Required & Attribute.Unique;
    is_active: Attribute.Boolean & Attribute.DefaultTo<true>;
    card_entity: Attribute.Relation<
      'api::card-category.card-category',
      'oneToOne',
      'api::card-entitie.card-entitie'
    >;
    card_banner: Attribute.Relation<
      'api::card-category.card-category',
      'oneToOne',
      'api::card-banner.card-banner'
    >;
...
export interface ApiCardEntitieCardEntitie extends Schema.CollectionType {
  collectionName: 'card_entities';
  info: {
    singularName: 'card-entitie';
    pluralName: 'card-entities';
    displayName: 'Card Entities ';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    features_card_image: Attribute.Media & Attribute.Required;
    preview_card_image: Attribute.Media & Attribute.Required;
    card_name_Heading: Attribute.String & Attribute.Required;
    joining_title: Attribute.String & Attribute.Required;
    joining_value: Attribute.String & Attribute.Required;
    annual_title: Attribute.String & Attribute.Required;
    annual_value: Attribute.String & Attribute.Required;
    reward_title: Attribute.String & Attribute.Required;
    reward_value: Attribute.String;
    cash_back_title: Attribute.String;
    cash_back_value: Attribute.String;
    card_category: Attribute.Relation<
      'api::card-entitie.card-entitie',
      'oneToOne',
      'api::card-category.card-category'
...
export interface ApiExclusiveOfferExclusiveOffer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    offerMessage: Attribute.String & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::card-entitie.card-entitie': ApiCardEntitieCardEntitie;
